        ...
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex flex-col justify-end gap-2'>
              {!item.cancelled && item.payment && !item.isCompleted && <button className='text-sm text-white text-center sm:min-w-48 py-2 border rounded bg-green-300 cursor-not-allowed'  >Paid & Processing..</button>}
